...
body{{font-family:system-ui,sans-serif;margin:0;background:#f3f5f7;color:#17202a}}header{{background:#17202a;color:white;padding:1.2rem 2rem}}main{{max-width:1200px;margin:1.5rem auto;padding:0 1rem}}.grid{{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:1rem}}.card,.panel{{background:white;border-radius:12px;padding:1.2rem;box-shadow:0 2px 12px #0001;margin-bottom:1rem}}.hero{{display:flex;justify-content:space-between;gap:1rem;align-items:center;flex-wrap:wrap}}form{{display:grid;gap:.7rem}}label{{display:grid;gap:.25rem;font-weight:700}}input,select,textarea,button{{padding:.7rem;border:1px solid #bcc5cc;border-radius:8px}}textarea{{font:inherit}}button,.button{{display:inline-block;background:#17202a;color:white!important;padding:.7rem;border:1px solid #17202a;border-radius:8px;text-decoration:none;font-weight:700;cursor:pointer}}button.danger{{background:#922b21}}.row{{display:flex;gap:.6rem;flex-wrap:wrap}}.row form{{display:inline-block}}.muted{{color:#65727e;font-size:.9rem}}.notice{{padding:1rem;border-radius:8px;margin-bottom:1rem}}.success{{background:#d5f5e3}}.error{{background:#fadbd8}}code{{overflow-wrap:anywhere}}section[id]{{scroll-margin-top:1rem}}
